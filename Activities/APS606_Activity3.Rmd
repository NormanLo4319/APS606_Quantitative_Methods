...
c. Find the probability for randomly select a score **below 8.5** from this simulated data. P(X<8.5)

d. Find the probability for randomly select a score **above 14.6** from this simulated data. P(X>14.6)

e. Find the probability for randomly select a score **between 9.5 and 13.2** from this simulated data. P(9.5<X<13.2)

f. What is the score that is at the **75th percentile** of this data? P(X < x) = 0.75

```{r}
# Simulate a normally distributed data set
n <- rnorm(10000, mean = 11.5, sd = 1.35)
...
print(paste("The probability to randomly select a score below 8.5 is ", ))

# Part d



print(paste("The probability to randomly select a score above 14.6 is ", ))

# Part e



print(paste("The probability to randomly select a score between 9.5 and 13.2 is ", ))

# Part f



print(paste("The score that is at 75th percentile in the data set is ", ))
